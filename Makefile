...
SRCS_FILE = main.c init.c event.c init_parcing.c ft_read_file.c ft_init_final_map.c  \
			check_parcing.c ft_free.c ./render/raycasting.c ./render/render.c convert_char_to_int.c
